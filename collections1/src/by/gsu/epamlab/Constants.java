...
public class Constants {
    ...
    public static final String WEEK_PURCHASES_ENUM_MAP_WITHOUT_MILK = "Week-Purchase enumMap without milk: ";
    ...
    public static final String WEEKDAY_PURCHASES_ENUM_MAP = "Week-Purchases enumMap";
}
